---
name: retriever
description: General retriever behavior when no specific tool or skill is required. Use for simple replies, clarifications, or when the user message does not match MCP resources, CIQ, or AuthZEN.
tags:
  - retriever
  - demo
examples:
...
Use this skill when the user message does not require MCP tools, CIQ, or AuthZEN.
