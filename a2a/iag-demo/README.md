...
The stack boots three Agent Gateway instances (protecting the orchestrator,
retriever, and weather agents respectively) plus four in-repo services
...
| `weather` | `6004` | Weather agent (Open-Meteo client) |
