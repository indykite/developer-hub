...
_EXECUTE_DEFS = [
    ...
    },
    {
        ...
        "input_params": {"customer_external_id": "rebecca"},
    },
    {
        "slot": "4",
    ...
    },
    {
        ...
        "input_params": {
            "decision_external_id": "decision_002",
            "decision_description": "Refund approved as an exception to the refund policy",
            "document_external_id": "refund_policy",
            "ticket_external_id": "ticket_001",
        },
    },
]
...
@api_ciq_execute.get("/execute10", tags=[tag])
def show_execute_form_10():
    """CanBank CIQ Execute 10 - Store Decision."""
    return render_template(
        "ciq_execute/ciq_execute_form.html",
        default_data=_execute_default("10"),
    )
