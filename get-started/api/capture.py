...
def show_create_form():
    """Display the capture form with a default node example."""
    default_data = {}
    return render_template("capture/create_form.html", default_data=default_data)


@api_capture.post("/create", tags=[tag])
def create_capture():
    """Capture nodes with the provided form data."""
    # Get form data - the nodes JSON
    try:
