...
def show_create_form():
    ...
    default_data = {
        "claims_mapping": {"email": {"selector": "email"}, "name": {"selector": "name"}},
        "description": "Token introspect for banking users",
        "display_name": "Banking Token Introspect",
        "ikg_node_type": "User",
        "jwt_matcher": {"issuer": "https://auth.fakebank.com", "audience": "banking-app"},
        "name": "banking-token-introspect",
