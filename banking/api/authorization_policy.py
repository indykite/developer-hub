...
def show_create_form():
    ...
    default_policy = (
        '{"meta":{"policy_version":"2.0-kbac"},"subject":{"type":"User"},"actions":["VIEW_ACCOUNT"],'
        '"resource":{"type":"FinAccount"},'
        '"condition":{"cypher":"MATCH (subject:User)-[:OWNS]->(resource:FinAccount)"}}'
    )
    default_data = {
        "project_id": project_id,
        "description": "Allow a banking user to view a FinAccount they own",
        "display_name": "Banking - View Owned Account",
        "name": "banking-view-owned-account",
